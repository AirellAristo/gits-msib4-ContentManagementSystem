...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary mx-3">
        <div class="container-fluid">
          <a class="navbar-brand" href="{{ url('/admin') }}">TokoKu</a>
                  ...
                  <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
                          ...
                          </svg>{{ " Hello , ".ucfirst(auth()->user()->username) }}
                    </a>
                    <ul class="dropdown-menu">
                        ...
                        <li><hr class="dropdown-divider"></li>
                        <li> <form action="/logout" method="POST" >@csrf <button class="btn btn-link" style="color: black;text-decoration: none;">Log Out</button> </form> </li>
                    </ul>
                  </li>
                </ul>
              </div>
